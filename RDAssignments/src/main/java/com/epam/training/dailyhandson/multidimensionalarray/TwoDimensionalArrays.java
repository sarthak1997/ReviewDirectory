...
/**
 * This class contains all the basic operations with respect to a 2-d array of {@code Number} type.
 * */
public class TwoDimensionalArrays<T extends Number> {
   ...
   * @param rows as number of rows of the matrix
   * @param cols as number of columns of the matrix
   * */
  ...
  /**
   * method to generate a string that while printing shows the 
   * result as matrix.
  ...
  /**
   * method that prints the sum of rows, columns and diagonals elements in the array
   * such that rows and columns are equal.
   * @throws AsymmetricMatrixException in case of asymmetric matrix
   * */
